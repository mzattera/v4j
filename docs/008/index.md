...
| <span style="color:green">**SLOT MACHINE**</span> 	| 3'110	| 1'113	| 62.040%	| <span style="color:orange">0.358</span>	| 0.216	| <span style="color:red">0.270</span> |
  ...
  - When implementing Pelling's state machine, I assumed all arrows have the same meaning (even if some are dashed) and the red boxes are non-emitting states. The author claims the model should generate about 1'200 terms, but in my interpretation a loop in "Column 3" makes this generate a potentially infinite number of terms.
