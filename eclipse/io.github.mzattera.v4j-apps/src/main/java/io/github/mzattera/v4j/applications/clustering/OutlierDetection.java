...
public final class OutlierDetection {
	...
	/**
	 * Calculate average distance for each BoW from others and prints the results.
	 * This supposedly helps finding outliers.
	 * 
	 * @param dist
	 * @param bow
	 * @throws DimensionMismatchException
	 */
	public static void process(DistanceMeasure dist, List<BagOfWords> bow) throws DimensionMismatchException {
