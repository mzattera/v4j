...
Potentially, a model that generate all possible combinations of letters in the Voynich alphabet will generate all of the terms in the manuscript (recall=1), but will also generate a 
